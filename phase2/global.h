...
constexpr unsigned short int GEN_ORDER = 1;
constexpr unsigned short int SET_QUANTITY = 2;
constexpr unsigned short int DEL_CART = 3;
constexpr unsigned short int CLR_CART = 4;
